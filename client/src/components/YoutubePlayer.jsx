    ...
    videoForward = () => {
      ...
      render () {
        ...
        return (
          ...
          />
          <button className={"playerButton"} onClick={this.videoBackward}> -5sec </button>
          <button className={"playerButton"} onClick={this.videoPlay}>Play</button>
          <button className={"playerButton"} onClick={this.videoPause}>Pause</button>
          <button className={"playerButton"} onClick={this.videoForward}> +5sec </button>
           <h1>{Math.floor(this.state.currentTime)} : {this.state.duration}</h1> 
